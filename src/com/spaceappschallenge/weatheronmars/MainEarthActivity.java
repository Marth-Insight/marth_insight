...
import com.spaceappschallenge.weatheronmars.business.WeatherReportForEarth;
...
public class MainEarthActivity extends FragmentActivity 
{
	...
	public class parseXMLTask extends AsyncTask<Void, Void, Void> 
	{
		...
		{
			try {
				wr = WeatherReportForEarth.parseXMLForEarth(MainEarthActivity.this);
	...
	public class RefreshTask extends AsyncTask<Void, Void, Void> 
	{
		...
		protected Void doInBackground(Void... params)
		{
			...
			try
			{
				WeatherReportForMars.download(MainEarthActivity.this);
			}
			catch (IOException e)
			{
				e.printStackTrace();
	...
	public void showTrivia(View view) 
	{
		...
		Toast toast = new Toast(MainEarthActivity.this);
